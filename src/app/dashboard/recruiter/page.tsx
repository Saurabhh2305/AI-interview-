        ...
        <div>
          ...
          <nav className="flex flex-col p-4 space-y-1">
            ...
            <Button
              ...
              className="w-full justify-start"
              onClick={() =>
                router.push("/dashboard/recruiter/applicants")
              }
            >
              <Users className="mr-3 h-5 w-5" />
              View Applicants
            ...
            {/* ⭐ NEW BUTTON — Recruiter Responsibilities */}
            <Button
              variant="ghost"
              className="w-full justify-start"
              onClick={() =>
                router.push("/dashboard/recruiter/recruiter-responsibilities")
              }
            >
            ...
            <Button
              ...
              className="w-full justify-start"
              onClick={() =>
                router.push("/dashboard/recruiter/reports")
              }
            >
              <FileBarChart className="mr-3 h-5 w-5" />
              Reports & Analytics
      ...
      <main className="flex-1 p-10 overflow-y-auto">
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* ⭐ Recruiter Responsibilities Card */}
            <Card className="shadow-md">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg">
